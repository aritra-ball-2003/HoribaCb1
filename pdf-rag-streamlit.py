...
def create_retriever(vector_db, llm):
    ...
    QUERY_PROMPT = PromptTemplate(
        ...
        template="""You are an AI language model assistant for Horiba India. Your task is to generate five
different versions of the given user question to retrieve relevant documents from
a vector database related horiba product only. By generating multiple perspectives on the user question, your
